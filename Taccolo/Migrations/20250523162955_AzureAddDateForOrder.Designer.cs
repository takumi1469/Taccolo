...
namespace Taccolo.Migrations
{
    ...
    [Migration("20250523162955_AzureAddDateForOrder")]
    partial class AzureAddDateForOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Taccolo.Pages.Data.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Taccolo.Pages.Data.LearningSet", b =>
                {
                    ...
                    b.Property<DateTime?>("DateForOrder")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Taccolo.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Taccolo.Pages.Data.HelpReply", b =>
                {
                    b.HasOne("Taccolo.Pages.Data.HelpRequest", "HelpRequest")
                        .WithMany("HelpReplys")
